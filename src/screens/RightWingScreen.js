...
class RightWingScreen extends Component {
  ...
  componentWillMount() {
    fetch("https://free-news.p.rapidapi.com/v1/search?q=bjp||modi||love||&lang=en&page_size=20", {
	"method": "GET",
	"headers": {
          ...
          Handpicked articles for you, <Text>({this.state.index})</Text>
				...
				>
				 ...
				 <View>
					  ...
					  {isLoading ? <View style={{height:'100%',width:'100%'}}><InstagramLoader active /><InstagramLoader active /></View> : (
...
<View
	...
	/>
	<View style={{marginBottom:height*0.022}}>
	<Animatable.View animation="pulse" iterationCount='infinite' useNativeDriver='true' delay={150}>
	<Button 
	buttonStyle={{
		backgroundColor: "#585bc5"
	 }}
	  icon={{
		name: "check",
		size: height*0.016,
	...
	onPress={() => Linking.openURL(item.link)}
		...
		<View style={{marginTop:10,backgroundColor: 'rgba(142,143,214,0.5)',borderBottomRightRadius:30,borderTopLeftRadius:30,padding:5,marginHorizontal:20}}>
...
export default RightWingScreen
