...
export default class Feedback extends Component {
  ...
  render() {
    ...
    return (
		...
		<ImageBackground
		source={require("../images/background_about.jpg")}
		style={{ width: "100%", height: "100%" }}
	  >
	   
                    <View style={{ marginTop: height*0.050, justifyContent:'center' }}>
                    {/* <Animatable.View animation='bounceInDown' delay='100'>    */}
                    <Animatable.View animation='bounceInDown' delay={250}>
...
{/* </Animatable.View> */}
          ...
          <Animatable.View animation='bounceIn' delay={250}>
                    <View style={{paddingHorizontal:width*0.048,backgroundColor: 'rgba(0,0,0,0.4)',marginHorizontal:width*0.024,borderTopLeftRadius:height*0.033,borderBottomRightRadius:height*0.013,marginBottom:height*0.0111,paddingVertical:10}}>
 ...
 Click here for the main Website.
                ...
                <View style={{paddingHorizontal:width*0.048,backgroundColor: 'rgba(0,0,0,0.4)',marginHorizontal:width*0.024,borderTopLeftRadius:height*0.033,borderBottomRightRadius:height*0.033,marginBottom:height*0.0111,paddingVertical:10,marginTop:10}}>
