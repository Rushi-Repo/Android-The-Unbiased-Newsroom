...
import { View, Text, Image, ImageBackground, TextInput, Linking, StyleSheet, RefreshControl, Dimensions,Animated,Button,Easing} from "react-native";
...
<Header /> 
              ...
              <ScrollView >
                ...
                <View style={{backgroundColor: 'rgba(142,143,214,0.5)',marginTop:height*0.0111,marginBottom:height*0.0111,marginLeft:width*0.024,borderTopLeftRadius:height*0.033,borderBottomLeftRadius:height*0.033}}>
                <Animatable.View animation="bounceInLeft" useNativeDriver='true' delay={200}> 
                  <View>
                <Text
            style={{
...
/>        
          <View style={{paddingHorizontal:width*0.048,backgroundColor: 'rgba(142,143,214,0.5)',marginHorizontal:width*0.024,borderTopLeftRadius:height*0.033,borderBottomRightRadius:height*0.033,marginTop:height*0.0111,marginBottom:height*0.0111}}>
...
<View style={{backgroundColor: 'rgba(142,143,214,0.5)',marginHorizontal:width*0.024,borderTopLeftRadius:height*0.033,borderBottomRightRadius:height*0.033,marginTop:height*0.0111,marginBottom:height*0.0111}}>
                
<Animatable.View animation="bounceInUp" delay={450}>
